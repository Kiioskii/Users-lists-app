...
<body>
    ...
    <div class="main-container">
        <div class="search-container" id="pink-gradient-bcg">
            <div>
                <input type="text" class="search-bar" placeholder="Search">
                <button class="main-btn" id="search-btn">Search</button>
                <button class="main-btn"><a href="./addUser.php">Dodaj użytkwonika</a></button>
            </div>
        </div>
        <div class="users-data-container" id="sea-bcg">
            <div id="database-container"></div> <!-- this container is replaced by data from a .js file-->
        </div>
    </div>
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.3/jquery.min.js"></script>
    <script src="../../js/Users/getUsers.js"></script>
</body>
